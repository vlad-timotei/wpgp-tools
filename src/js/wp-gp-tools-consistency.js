var user_settings = { 'search' : 'enabled', 'prevent_unsaved': 'disabled', 'autocomplete_suggestion' : false}; 
/** 'prevent_unsaved': 'disabled' because it doesn't work properly yet ToDO: in future version improve algorithm */
...
function elements_init(){
	...
	$(window).on("beforeunload", function(){
		close_tabs('all');
		if( user_edited && user_settings['prevent_unsaved'] == "enabled" && $(".editor:visible textarea").val() !== undefined )
			return false;
		} );
	}
}
