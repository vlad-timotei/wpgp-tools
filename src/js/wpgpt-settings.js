...
settings_li.appendChild( document.createElement( 'a' ) ).appendChild( document.createTextNode( 'WPGPT Settings' ) );
...
function wpgpt_settings_page() {
	...
	shortcuts_el_custom.innerHTML = `<div class="gp-header gp-row"><div class="gp-shortcut">Custom shortcuts</div><div class="gp-shortcut">Key</div><div class="gp-shortcut">Alternative key for MacOS</div></div>
	...
	<div class="gp-row"><div class="gp-shortcut">Insert all <span class="f">N</span>on-translatables</div><div class="gp-shortcut">Alt + <span class="f">N</span></div><div class="gp-shortcut">control + <span class="f">N</span></div></div>
...
if ( null === localStorage.getItem( 'wpgpt-gd-unified' ) && null === localStorage.getItem( 'gd_locales_date' ) ) {
	...
	x.textContent = 'Close';
	x.href = '#';
	gd_compat.innerHTML = 'For a better unified experience, features merged in <b>GlotDict</b> will soon become <b>unavailable in WPGPT</b>! Please consider using <a href="https://chrome.google.com/webstore/detail/glotdict/jfdkihdmokdigeobcmnjmgigcgckljgl?hl=en">GlotDict</a>. ';
	...
	x.addEventListener( 'click', e => {
		e.preventDefault();
		localStorage.setItem( 'wpgpt-gd-unified', 'closed' );
